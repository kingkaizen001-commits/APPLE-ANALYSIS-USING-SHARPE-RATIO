...
def req(method: str, url: str, api_key: str | None = None, payload: dict | None = None) -> tuple[int, str]:
    body = None
...
def main() -> None:
    ...
    assert_status("forecast_without_key", s, 401)
    ...
    assert_status("forecast_with_key", s, 200)
    ...
    s, _ = req(
        "POST",
        f"{args.base_url}/alerts/evaluate",
        api_key=args.api_key,
        payload={
            "sku": "SKU-001",
    ...
    assert_status("alerts/evaluate", s, 200)
